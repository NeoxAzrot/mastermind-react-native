...
export const positionReleased = ({ moveX, moveY }) => (isInDropArea(moveY)
  ...
  : -1)
// Fonction pour générer une nouvelle combinaison à trouver
export const genNewPassword = () => {
  let password = []
  for(let i = 0; i < 4; i++) {
    password.push(theme.balls[getRandom(0, theme.balls.length-1)])
  }
  return password //['#48ADA2', '#F2982F', '#48ADA2', '#48ADA2']
}

// Fonction pour générer un nombre aléatoire dans un interval fermé
